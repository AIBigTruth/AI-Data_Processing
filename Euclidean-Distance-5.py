...
for file in files:
    ...
    for i in range(len(fiveDatas)):
        if (i % 2) != 0:   # one
            twoData = [int(fiveDatas[i][0]), int(fiveDatas[i][1]), int(fiveDatas[i][2]), int(fiveDatas[i][3])]
            twoDatas.append(twoData)

        else:
            oneData = [int(fiveDatas[i][0]), int(fiveDatas[i][1]), int(fiveDatas[i][2]), int(fiveDatas[i][3])]
