...
file_dir = "F://test/find-file/dst-image/"
save_dir = "F://test/find-file/gauss_image/"
...
for img_name in os.listdir(file_dir):
    ...
    # cv2.imwrite(save_dir + img_name[0:7] + '_salt.jpg', img_salt)
    #img_gauss = addGaussianNoise(img, 0.3)
    #cv2.imwrite(save_dir + img_name[0:-4] + '_noise.jpg',img_gauss)
    ...
    # 3、模糊
    blur = cv2.GaussianBlur(img, (5, 5), 1.5)
    cv2.imwrite(save_dir + img_name[0:-4] + '_blur.jpg',blur)

    # 4、 旋转
    # img_rotate = Rotate(img, angle=15, scale=0.9)
    # cv2.imwrite(save_dir + img_name[0:-4] + '_rotate.jpg', img_rotate)

    #img_change = change(img)
    #cv2.imwrite(save_dir + img_name[0:-4] + '_change.jpg', img_change)
