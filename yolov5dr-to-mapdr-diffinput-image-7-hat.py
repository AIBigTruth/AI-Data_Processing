...
path ='F://github/yolov5-v5/runs/detect/clothes-hat-random-300-16-7000/labels/'
path_image ='F://github/yolov5-v5/runs/detect/clothes-hat-random-300-16-7000/image/'
...
for file in files:
    ...
    for i in range(x):
        for j in range(y):
            ...
            c = float(dataMat[i][0])
            if c == 0:
                newData1 = ['hat', r, int(x1), int(y1), int(x2), int(y2)]
            elif c == 1:
