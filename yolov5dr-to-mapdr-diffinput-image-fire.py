...
path ='F://github/yolov5-v5/runs/detect/fire-smoke-random-16-200-0.5-10000/labels/'
path_image ='F://github/yolov5-v5/runs/detect/fire-smoke-random-16-200-0.5-10000/image/'
    ...
    for i in range(x):
        for j in range(y):
            ...
            if c == 0:
                ...
                newData1 = ['white_smoke', r, int(x1), int(y1), int(x2), int(y2)]
